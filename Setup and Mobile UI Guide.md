...
- On failure: error Snackbar displayed.
 ...
 ![](Report7_FinalProjectReport_files/image014.png) 
...
![](Report7_FinalProjectReport_files/image015.png)
...
![](Report7_FinalProjectReport_files/image016.png)
...
- On failure (unregistered contact, network error): error Snackbar displayed.
 ...
 ![](Report7_FinalProjectReport_files/image017.png)
...
- Backend may enforce a maximum resend limit; error shown if exceeded.
 ...
 ![](Report7_FinalProjectReport_files/image018.png)
...
- If no location is selected, tapping "Sản phẩm" or "Nhân viên" shows a warning Snackbar.
 ...
 ![](Report7_FinalProjectReport_files/image019.png)       ![](Report7_FinalProjectReport_files/image020.png) 

###### Figure 3.2.6.1: Home screen version Vietnamese

![](Report7_FinalProjectReport_files/image021.png)         ![](Report7_FinalProjectReport_files/image022.png) 
...
- On failure: error Snackbar displayed.
 ...
 ![](Report7_FinalProjectReport_files/image023.png)
...
- Tapping any notification card marks it as read and navigates to **Notification Details**.
 ...
 ![](Report7_FinalProjectReport_files/image024.png)
...
- Back arrow in AppBar returns to the **Notification** list.
 ...
 ![](Report7_FinalProjectReport_files/image025.png)
...
- On confirm: order status set to Cancelled.
 ...
 ![](Report7_FinalProjectReport_files/image026.png)
...
- Download PDF order invoice.
 ...
 ![](Report7_FinalProjectReport_files/image027.png)
...
- On failure: validation errors displayed.
 ...
 ![](Report7_FinalProjectReport_files/image028.png)        ![](Report7_FinalProjectReport_files/image029.png) 
...
- After AI processing, navigates to **Draft Order AI Screen** with parsed items.
 ...
 ![](Report7_FinalProjectReport_files/image030.png)
...
- "Tiếp theo" / "Thanh toán" validates form (at least 1 product required) and navigates to the **Order Payment** sub-flow screens.
 ...
 ![](Report7_FinalProjectReport_files/image031.png)

###### Figure 3.2.15.1: Select product

![](Report7_FinalProjectReport_files/image032.png)

###### Figure 3.2.15.2: Select payment method

![](Report7_FinalProjectReport_files/image033.png)

###### Figure 3.2.15.3: Order processing

![](Report7_FinalProjectReport_files/image034.png)
...
- "Xóa" shows a confirmation dialog; on confirm the record is permanently deleted.
 ...
 ![](Report7_FinalProjectReport_files/image035.png)
...
- On failure: error Snackbar displayed.
 ...
 ![](Report7_FinalProjectReport_files/image036.png)
...
- Back arrow in AppBar returns to **Debt Customer List**.
 ...
 ![](Report7_FinalProjectReport_files/image037.png)
...
![](Report7_FinalProjectReport_files/image038.png)
...
- Tapping an import card navigates to **Receipt Detail** (read-only view).
 ...
 ![](Report7_FinalProjectReport_files/image039.png)
...
- Total import value shown at the bottom.
 ...
 ![](Report7_FinalProjectReport_files/image040.png)
...
- Invoice mode: after image attach, system auto-navigates to **Draft Import Receipt**.
 ...
 ![](Report7_FinalProjectReport_files/image041.png)        ![](Report7_FinalProjectReport_files/image042.png) 
...
- "Xác nhận" / "Tiếp tục" to **Confirm Import**.
 ...
 ![](Report7_FinalProjectReport_files/image043.png)
...
- Saves without full navigation.
 ...
 ![](Report7_FinalProjectReport_files/image044.png)
...
- On failure: inline validation errors displayed.
 ...
 ![](Report7_FinalProjectReport_files/image045.png)        ![](Report7_FinalProjectReport_files/image046.png) 
...
- On confirm: selling prices updated for all selected products.
 ...
 ![](Report7_FinalProjectReport_files/image047.png)        ![](Report7_FinalProjectReport_files/image048.png) 
...
**![](Report7_FinalProjectReport_files/image049.png)                   ![](Report7_FinalProjectReport_files/image050.png)** 
...
- On failure: error Snackbar displayed.
 ...
 ![](Report7_FinalProjectReport_files/image051.png)

###### Figure 3.2.37.1: Invite employee

![](Report7_FinalProjectReport_files/image052.png)
...
- "Lưu" persists changes; location's employee list updated.
 ...
 ![](Report7_FinalProjectReport_files/image053.png)

###### Figure 3.2.38.1: Assign employee

![](Report7_FinalProjectReport_files/image054.png)

###### Figure 3.2.38.2: Assign employee

![](Report7_FinalProjectReport_files/image055.png)
...
![](Report7_FinalProjectReport_files/image056.png)
...
![](Report7_FinalProjectReport_files/image057.png)
...
![](Report7_FinalProjectReport_files/image058.png)
...
![](Report7_FinalProjectReport_files/image059.png)
...
![](Report7_FinalProjectReport_files/image060.png)
...
![](Report7_FinalProjectReport_files/image061.png)
...
- "Quản lý địa điểm" link at the bottom navigates to **Business Location List**.
 ...
 ![](Report7_FinalProjectReport_files/image062.png)
...
- Delete icon shows a confirmation dialog; on confirm location is permanently deleted.
 ...
 ![](Report7_FinalProjectReport_files/image063.png)
...
- On failure: inline errors shown.
 ...
 ![](Report7_FinalProjectReport_files/image064.png)
...
- "Lưu" updates the location → list refreshes with Snackbar on success.
 ...
 ![](Report7_FinalProjectReport_files/image065.png)        ![](Report7_FinalProjectReport_files/image066.png) 
...
- "Lịch sử giao dịch" shows a paginated list of past subscription payment transactions.
 ...
 ![](Report7_FinalProjectReport_files/image067.png)       

###### Figure 3.2.52.1: Current subscription

![](Report7_FinalProjectReport_files/image068.png)
...
- "Lưu" in a sticky bottom bar saves all configuration with a success Snackbar.
 ...
 ![](Report7_FinalProjectReport_files/image069.png)                       ![](Report7_FinalProjectReport_files/image070.png) 
...
![](Report7_FinalProjectReport_files/image071.png)
