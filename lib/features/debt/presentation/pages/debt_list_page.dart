...
class _DebtListPageState extends State<DebtListPage> {
  ...
  final ActionGuard _openDebtorFormGuard = ActionGuard();
  ...
  Future<void> _requestOpenDebtorForm({DebtorEntity? existing}) async {
    await _openDebtorFormGuard.run(() async {
      await _showDebtorForm(existing: existing);
    });
  }
