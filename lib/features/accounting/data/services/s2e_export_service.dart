...
class S2eExportService {
  ...
  static const _thuVaoAliases = ['income', 'amountIn', 'deposit', 'thuVao', 'revenue', 'finalAmount'];
  static const _chiRaAliases = ['expense', 'amountOut', 'withdrawal', 'chiRa', 'cost', 'amount'];
  ...
  static Future<File?> export({
    ...
    try {
      ...
      for (var i = 0; i < visible; i++) {
        ...
        _setAmount(sheet, r, 3, _pick(item, 'thu_vao', _thuVaoAliases));
        _setAmount(sheet, r, 4, _pick(item, 'chi_ra', _chiRaAliases));
      }
