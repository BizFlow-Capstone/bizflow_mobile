              ...
              _GuideSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: AppSpacing.sm),
                    _RateTable(
                      sttLabel: l10n.translate('accounting.period_guide_col_stt'),
                      ...
                      rows: [
                        _RateTableRowData(
                          ...
                          details: _splitBulletText(
                            l10n.translate('accounting.period_guide_row_1_details'),
                          ),
                        ),
                        _RateTableRowData(
                          stt: '2',
                          ...
                          details: _splitBulletText(
                            l10n.translate('accounting.period_guide_row_2_details'),
                          ),
                        ),
                        _RateTableRowData(
                          stt: '3',
                          ...
                          details: _splitBulletText(
                            l10n.translate('accounting.period_guide_row_3_details'),
                          ),
                        ),
                        _RateTableRowData(
                          stt: '4',
                          ...
                          details: _splitBulletText(
                            l10n.translate('accounting.period_guide_row_4_details'),
                          ),
                        ),
                        _RateTableRowData(
                          stt: '5',
                          title: l10n.translate('accounting.period_guide_row_5_title'),
                          vat: l10n.translate('accounting.period_guide_row_5_vat'),
                          tncn: l10n.translate('accounting.period_guide_row_5_tncn'),
                          details: _splitBulletText(
                            l10n.translate('accounting.period_guide_row_5_details'),
                          ),
                        ),
                      ],
                    ),
