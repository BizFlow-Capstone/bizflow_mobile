...
class AIDraftRevenueDialog extends StatefulWidget {
  ...
  @override
  State<AIDraftRevenueDialog> createState() => _AIDraftRevenueDialogState();
}

class _AIDraftRevenueDialogState extends State<AIDraftRevenueDialog> {
  late List<_RevenueAIDraft> drafts;
  late List<BusinessTypeDto> businessTypes;
  ...
  Future<void> _toggleVoiceCapture(AppLocalizations l10n) async {
    ...
    final path =
        '${recordDir.path}/accounting_revenue_${DateTime.now().millisecondsSinceEpoch}.m4a';
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            l10n.translate('accounting.ai_draft_revenue_title'),
              ...
              children: [
                ...
                if (drafts.isEmpty)
                  ...
                  ...drafts.asMap().entries.map((entry) {
                    ...
                    return _KeyedDraftItem(
                      key: ValueKey('revenue_draft_${index}_${draft.id}'),
                      index: index,
                      draft: draft,
...
class _KeyedDraftItem extends StatefulWidget {
  final int index;
  ...
  @override
  State<_KeyedDraftItem> createState() => _KeyedDraftItemState();
}
...
class _RevenueAIDraft {
  ...
  String get id => '$description$amountText$revenueDate';
}
